class ApiHandler {
  ...
  sendGiftCard = (formValues, success = () => { }, failure = () => { }) => {
    ...
    const body = {
      ...
      "purchaser_name": purchaser_first_name,
      "purchaser_email": purchaser_email,
      "recipient_name": formValues.giftToSelf == true ? recipient_first_name : purchaser_first_name ,
    ...
    this.getResult("/giftcards/create", "POST", body, '', (response) => {
  ...
  addBalanceToGiftCard = (formData, success = () => { }, failure = () => { }) => {
    const body = {
      ...
      "amount": formData.amountForReload == '' ? formData.customAmountForReload : formData.amountForReload
    }

    this.getResult("/giftcards/reload_gift_card", "PATCH", body, '', (response) => {
      if (response.success === false) {
        failure(response.msg)
      } else if (response.success === true) {
        success(response);
